    ...
    dibujarTableroDOM(){
        ...
        for (let i = 0; i < this.filas; i++) {
            ...
            for (let j = 0; j < this.columnas; j++) {
                ...
                columna.dataset.despejar = false;
...
class Buscaminas extends Tablero {
    ...
    despejar(elEvento) {
        ...
        this.despejar_celda(celda);
    }
    
    despejar_celda(celda){
        ...
        let rutaBandera = "http://127.0.0.1:5500/Busca_minas/imagenes/bandera.png";
                    ...
                    if (cFila >= 0 && cFila < this.filas) {
                        for (let cColumna = columna - 1; cColumna <= columna + 1; cColumna++) {
                            if (cColumna >= 0 && cColumna < this.columnas && !estaDespejado) {
                                ...
                                estaDespejado = (celdaNueva.dataset.despejar == `true`);
                                if (!estaDespejado){
                                    console.log(`f${cFila}_c${cColumna}`);
                                    this.despejar_celda(celdaNueva);
                                }
                            }
                    }
                }
